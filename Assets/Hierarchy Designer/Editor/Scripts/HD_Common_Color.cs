...
{
    internal static class HD_Common_Color
    {
        #region Properties
        #region Hierarchy
        ...
        {
            return HD_Manager_Editor.IsProSkin ? DefaultDarkThemeSkinColor : DefaultLightThemeSkinColor;
        }

        public static Color GetDefaultEditorRowBackgroundColor()
        {
            return HD_Manager_Editor.IsProSkin ? DefaultDarkThemeSkinRowColor : DefaultLightThemeSkinRowColor;
        }

        public static Color GetHighlightedEditorColor()
        {
            return HD_Manager_Editor.IsProSkin ? HighlightedDarkThemeSkinColor : HighlightedLightThemeSkinColor;
        }

        public static Color GetHighlightedEditorRowColor()
        {
            return HD_Manager_Editor.IsProSkin ? HighlightedDarkThemeSkinRowColor : HighlightedLightThemeSkinRowColor;
        }

        public static Color GetHighlightedFocusedEditorColor()
        {
            return HD_Manager_Editor.IsProSkin ? HighlightedFocusedDarkThemeSkinColor : HighlightedFocusedLightThemeSkinColor;
        }

        public static Color GetHighlightedFocusedEditorRowColor()
        {
            return HD_Manager_Editor.IsProSkin ? HighlightedFocusedDarkThemeSkinRowColor : HighlightedFocusedLightThemeSkinRowColor;
        }

        public static Color GetSelectedEditorColor()
        {
            return HD_Manager_Editor.IsProSkin ? SelectedDarkThemeSkinColor : SelectedLightThemeSkinColor;
        }

        public static Color GetSelectedEditorRowColor()
        {
            return HD_Manager_Editor.IsProSkin ? SelectedDarkThemeSkinRowColor : SelectedLightThemeSkinRowColor;
        }

        public static Color GetRowColor()
        {
            return HD_Manager_Editor.IsProSkin ? RowColorDarkThemeSkinColor : RowColorLightThemeSkinColor;
        }
        #endregion
        ...
        {
            return HD_Manager_Editor.IsProSkin ? PrimaryFontColorDark : PrimaryFontColorLight;
        }

        public static Color GetPrimaryFontColorFaded()
        {
            return HD_Manager_Editor.IsProSkin ? PrimaryFontColorFadedDark : PrimaryFontColorFadedLight;
        }

        public static Color GetSecondaryFontColor()
        {
            return HD_Manager_Editor.IsProSkin ? SecondaryFontColorDark : SecondaryFontColorLight;
        }

        public static Color GetSecondaryFontColorFaded()
        {
            return HD_Manager_Editor.IsProSkin ? SecondaryFontColorFadedDark : SecondaryFontColorFadedLight;
        }

        public static Color GetTertiaryFontColor()
        {
            return HD_Manager_Editor.IsProSkin ? TertiaryFontColorDark : TertiaryFontColorLight;
        }

        public static Color GetPrimaryPanelColorTop()
        {
            return HD_Manager_Editor.IsProSkin ? PrimaryPanelColorTopDark : PrimaryPanelColorTopLight;
        }

        public static Color GetPrimaryPanelColorMiddle()
        {
            return HD_Manager_Editor.IsProSkin ? PrimaryPanelColorMiddleDark : PrimaryPanelColorMiddleLight;
        }

        public static Color GetPrimaryPanelColorBottom()
        {
            return HD_Manager_Editor.IsProSkin ? PrimaryPanelColorBottomDark : PrimaryPanelColorBottomLight;
        }

        public static Color GetSecondaryPanelColorTop()
        {
            return HD_Manager_Editor.IsProSkin ? SecondaryPanelColorTopDark : SecondaryPanelColorTopLight;
        }

        public static Color GetSecondaryPanelColorBottom()
        {
            return HD_Manager_Editor.IsProSkin ? SecondaryPanelColorBottomDark : SecondaryPanelColorBottomLight;
        }

        public static Color GetTertiaryPanelColorTop()
        {
            return HD_Manager_Editor.IsProSkin ? TertiaryPanelColorTopDark : TertiaryPanelColorTopLight;
        }

        public static Color GetTertiaryPanelColorBottom()
        {
            return HD_Manager_Editor.IsProSkin ? TertiaryPanelColorBottomDark : TertiaryPanelColorBottomLight;
        }

        public static Color GetPopupPanelColor()
        {
            return HD_Manager_Editor.IsProSkin ? PopupPanelColorDark : PopupPanelColorLight;
        }
        #endregion
        #endregion
