...
{
    internal class HD_Window_Rename : EditorWindow
    {
        #region Properties
        #region GUI
        ...
        {
            HD_Window_Rename window = GetWindow<HD_Window_Rename>("HD Rename Tool");
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("▷ RENAME TOOL", HD_Common_GUI.TabLabelStyle);
            GUILayout.Space(5);
            ...
            {
                EditorGUILayout.LabelField("Selected GameObjects", HD_Common_GUI.FieldsCategoryLabelStyle);
                GUILayout.Space(2);
