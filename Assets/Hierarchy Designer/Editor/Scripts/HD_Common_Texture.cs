...
namespace HierarchyDesigner
{
    internal static class HD_Common_Texture
    {
        ...
        #region Initializer
        static HD_Common_Texture()
        {
            #region Fallback Font
            if (!HD_Manager_Session.instance.FallbackFont)
            {
                fallbackFont = GetFallbackFont();
                HD_Manager_Session.instance.FallbackFont = fallbackFont;
            }
            else
            {
                fallbackFont = HD_Manager_Session.instance.FallbackFont;
            }
            #endregion

            #region Fallback Texture
            if (!HD_Manager_Session.instance.FallbackTexture)
            {
                fallbackTexture = CreateFallbackTexture();
                HD_Manager_Session.instance.FallbackTexture = fallbackTexture;
            }
            else
            {
                fallbackTexture = HD_Manager_Session.instance.FallbackTexture;
            }
            #endregion
        }
        #endregion
